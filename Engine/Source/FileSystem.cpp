...
FileSystem::FileSystem(const char* assetsPath) : name("FileSystem")
{
	...
	const char* dirs[] = {
		...
		MODELS_FOLDER, SHADERS_FOLDER, SCRIPTS_FOLDER, ANIMATIONS_FOLDER, BONES_FOLDER, SCENES_SAVE_FOLDER,
		PLAYER_SAVE_FOLDER, QUEST_SAVE_FOLDER, ENEMIES_SAVE_FOLDER, DIALOGUES_SAVE_FOLDER,CONFIG_SAVE_FOLDER
	};
