...
FileSystem::FileSystem(const char* assetsPath) : name("FileSystem")
{
	...
	const char* dirs[] = {
		RESOURCES_FOLDER, SETTINGS_FOLDER, LIBRARY_FOLDER, TEXTURES_FOLDER, MESHES_FOLDER, SCENES_FOLDER, MODELS_FOLDER, SHADERS_FOLDER, PREFABS_ASSETS_FOLDER, PREFABS_FOLDER, SCRIPTS_FOLDER, ANIMATIONS_FOLDER, BONES_FOLDER, PARTICLES_FOLDER
	};
