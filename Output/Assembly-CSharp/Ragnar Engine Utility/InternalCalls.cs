...
namespace RagnarEngine
{
    ...
    public class RayCast
    {
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        public static extern int PerceptionCone(Vector3 initPos, Vector3 _forward, int _angle, int rays, int radius, GameObject[] players, int size, GameObject[] colliders, int size2, float time);
